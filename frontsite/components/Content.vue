<template>
  ...
  <div class="content-box" :style="contentWidth">
    ...
    <div class="content-feed-ogText">
      <!-- 文字 -->
      <!-- <div v-if="!isContentExpanded" style="white-space: pre-wrap">
        {{ contentObj.content.length > 200 ? contentObj.content.slice(0, 200) + '...' : contentObj.content }}
      </div>
      <div v-else style="white-space: pre-wrap">{{ contentObj.content }}</div> -->
      <div style="white-space: pre-wrap">
        <MarkdownRenderer :content="contentObj.content" />
      </div>
    ...
    <div v-if="contentObj.content.length > 200">
      <span
...
export default {
  ...
  components: { ContentBottom, ContentFile, MarkdownRenderer },
  data() {
    //这里存放数据
    return {
      //是否点赞
